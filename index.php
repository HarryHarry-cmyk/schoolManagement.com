...
<body>
    <nav>
        <label class="logo">M.I.U.Y URDU HIGH SCHOOL & JR. COLLEGE</label>
        <ul>
            <li><a href="index.php">Home</a></li>
            <!-- <li><a href="admission_student.php">Admission</a></li> -->
            <li><a href="contact.php">Contact</a></li>
            <li><a href="register1.php" class="btn btn-primary">Register</a></li>
    ...
    <div class="section1">
        ...
        <center><img class="main_img" src="schoolImg.png"></center>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-mid-8">
                <center><h1>Welcome to M.I.U.Y URDU SCHOOL</h1></center>
